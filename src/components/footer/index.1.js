...
const Footer = ({children}) => (
  <div id="footer" className="w-100">
    ...
    <div className="inner">
      <div className="container px-5 text-center text-xlleft   py-4 d-xlflex justify-content-between col-xl-10">
        ...
        <div className="col col-lg-8 pl-5  pr-5">


       

        <div className="d-flex pt-5 align-items-end justify-content-end col">
        <p> Verkkosivut | React.js sovellukset | Valokuvaus </p>
        </div>
        ...
        <ul className="nav nav-dark align-self-end justify-content-end flex-xlrow flex-column mt-5 mt-lg-0 col">
