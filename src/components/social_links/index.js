...
const SocialLinks = ({children, className}) => (
  <div className={'social_links ' + className || ' d-flex '}>
    <a href="https://github.com/bujakasha"
    ...
    <a href="https://www.instagram.com/bujakasha_/" 
    ...
    <a href="https://fi.linkedin.com/in/casper-v%C3%A4resmaa-91b0b3155"
       title="Linkedin"
        className="btn s_link">
      <FontAwesomeIcon
        icon={['fab', 'linkedin']}
